...
const students = [
    { rollNo: '101', name: 'John Doe', branch: 'CSE', year: '2', marks: 85, grade: 'A' },
    { rollNo: '102', name: 'Jane Smith', branch: 'ECE', year: '3', marks: 78, grade: 'B+' },
    { rollNo: '103', name: 'Alice Johnson', branch: 'AIDE', year: '1', marks: 92, grade: 'A-' },
    { rollNo: '104', name: 'Bob Brown', branch: 'CSE', year: '2', marks: 88, grade: 'B' },
    { rollNo: '105', name: 'Charlie Davis', branch: 'ECE', year: '3', marks: 95, grade: 'A' },
  ];
...
document.getElementById('updateGrading').addEventListener('click', function () {
  ...
  gradingRules = { gradeA, gradeB, gradeC, gradeD };
